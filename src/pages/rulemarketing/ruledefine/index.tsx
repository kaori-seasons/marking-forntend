                        ...
                        <Card bordered>
                            ...
                            <Timeline>
                                <Timeline.Item color="gray">
                                    <br/> <Button type='primary' onClick={this.submit} icon={<PoweroffOutlined/>}
                                                  shape='round'> 开始定义 </Button>
                                    <br/>
                                    <br/>
                                    <br/>
                                </Timeline.Item>
                                <Timeline.Item color={timeline[0].c}
                                               dot={<ClockCircleOutlined className="timeline-clock-icon"
                                                                         style={{fontSize: timeline[0].f}}/>}>
                                    <h3>触发事件条件定义</h3>
                                    事件名称
                                    <br/>事件时段
                                    <br/>事件属性
                                ...
                                <Timeline.Item color={timeline[1].c}
                                               dot={<ClockCircleOutlined className="timeline-clock-icon"
                                                                         style={{fontSize: timeline[1].f}}/>}>
                                    <h3>画像属性条件定义</h3>
                                    标签名称
                                    <br/>比较逻辑
                                    <br/>标签值
                                ...
                                <Timeline.Item color={timeline[2].c}
                                               dot={<ClockCircleOutlined className="timeline-clock-icon"
                                                                         style={{fontSize: timeline[2].f}}/>}>
                                    <h3>行为次数条件定义</h3>
                                    事件名称
                                    <br/>事件时段
                                    <br/>事件属性
                                ...
                                <Timeline.Item color={timeline[3].c}
                                               dot={<ClockCircleOutlined className="timeline-clock-icon"
                                                                         style={{fontSize: timeline[3].f}}/>}>
                                    <h3>行为序列条件定义</h3>
                                    时间窗口
                                    <br/>事件名称
                                    <br/>事件属性
                        ...
                        <Row justify='start' onClick={() => this.timepoint(0)}>
                            <Col span={20}>
                                ...
                                <Card bordered={true} style={{marginTop: '10px'}}>
                                    ...
                                    <Form.Item>
                                        <a onClick={this.addTrigProperty}><PlusCircleFilled
                                            style={{fontSize: '16px', color: 'orange', paddingRight: '4px'}}/>事件属性</a>
                                    </Form.Item>
                                                ...
                                                return (
                                                    <Row key={p.pid}>
                                                        <Col style={{marginLeft: '10px'}}>
                                                            <Form.Item label='属性名'>
                                                                <Input placeholder="属性名" defaultValue={p.pname}
                                                                       onBlur={this.setTrigProp(p.pid, 'name')}/>
                                                            </Form.Item>
                                                        </Col>
                                                        <Col style={{marginLeft: '10px'}}>
                                                            <Form.Item label='运算符'>
                                                                <Select style={{width: 120}}
                                                                        onChange={this.setTrigProp(p.pid, 'oper')}>
                                                        ...
                                                        <Col style={{marginLeft: '10px'}}>
                                                            <Form.Item label='比较值'>
                                                                <Input placeholder="比较值" defaultValue={p.pvalue}
                                                                       onBlur={this.setTrigProp(p.pid, 'pvalue')}/>
                                                            </Form.Item>
                                                        </Col>
                                                        <Col style={{marginLeft: '10px'}}>
                                                            <a onClick={() => this.deleteTrigProp(p.pid)}><MinusCircleOutlined
                                                                style={{
                                                                    marginLeft: '10px',
                                                                    fontSize: '16px',
                                                                    color: '#FF4D4F',
                            ...
                            <Col span={20}>
                                ...
                                <Card bordered={false} style={{marginTop: '20px'}}>
                                    <span><h2>< CheckCircleFilled style={{color: '#52C400'}}/> &nbsp; 画像标签规则定义</h2>
                                        <Button onClick={this.addProfileTag} icon={<PlusCircleOutlined/>} type='ghost'
                                                size='small' shape='round'
                                                style={{marginRight: '5px', marginLeft: '10px'}}> 画像标签 </Button>
                                    </span>
                                    <Divider>
                                    </Divider>
                                    {
                                                ...
                                                <Row key={t.id} style={{marginTop: '10px'}}>
                                                    <Col style={{marginLeft: '10px'}}>
                                                        <Form.Item label='标签名称'>
                                                            <Select style={{width: 120}}
                                                                    onChange={this.setTag(t.id, 'tagName')}>
                                                    ...
                                                    <Col style={{marginLeft: '10px'}}>
                                                        <Form.Item label='运算符'>
                                                            <Select style={{width: 120}}
                                                                    onChange={this.setTag(t.id, 'tagOper')}>
                                                                <Option value="eq">等于</Option>
                                                                <Option value="lt">小于</Option>
                                                                <Option value="gt">大于</Option>
                                                                <Option value="lte">小于等于</Option>
                                                    ...
                                                    <Col style={{marginLeft: '10px'}}>
                                                        <Form.Item label='标签值'>
                                                            <Input placeholder="标签值"
                                                                   onBlur={this.setTag(t.id, 'tagValue')}/>
                                                        </Form.Item>
                                                    </Col>
                                                    <Col style={{marginLeft: '10px'}}>
                            ...
                            <Col span={20}>
                                ...
                                <Card bordered={false} style={{marginTop: '20px'}}>
                                    <span><h2><CheckCircleFilled style={{color: '#52C400'}}/> &nbsp; 行为次数规则定义</h2>
                                        <Button onClick={this.addEvent} icon={<PlusCircleOutlined/>} type='ghost'
                                                size='small' shape='round'
                                                style={{marginRight: '5px', marginLeft: '10px'}}> 行为事件 </Button>
                                    </span>
                                    <Divider>
                                    </Divider>
                                    {
                                            ...
                                            return (
                                                <Card style={{marginTop: '10px'}}>
                                                    <Row gutter={2} key={id}>
                                                        ...
                                                        <Col span={4}> <a
                                                            onClick={() => this.deleteEvent(id)}><MinusCircleFilled
                                                            style={{
                                                                marginLeft: '10px',
                                                                fontSize: '16px',
                                                                color: 'red',
                                                    ...
                                                    <Form.Item label="起止时间：">
                                                        <DatePicker.RangePicker showTime={true}
                                                                                onChange={this.setDateRange(id)}/>
                                                    </Form.Item>
                                                    <Form.Item label="发生次数：">
                                                        <Row gutter={2}>
                                                            <Col span={4}>
                                                                <Input style={{width: 80}} defaultValue={e.count}
                                                                       onBlur={this.setEventCount(id)}/>
                                                            </Col>
                                                        </Row>
                                                    </Form.Item>
                                                    <Form.Item>
                                                        <a onClick={() => this.addProperty(id)}><PlusCircleFilled
                                                            style={{
                                                                fontSize: '16px',
                                                                color: 'orange',
                                                                paddingRight: '4px'
                                                                        ...
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <Form.Item label='属性名'>
                                                                                <Input placeholder="属性名"
                                                                                       defaultValue={p.pname}
                                                                                       onBlur={this.setProp(id, p.pid, 'pname')}/>
                                                                            </Form.Item>
                                                                        </Col>
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <Form.Item label='运算符'>
                                                                                <Select style={{width: 120}}
                                                                                        onChange={this.setProp(id, p.pid, 'oper')}>
                                                                                    <Option value="eq">等于</Option>
                                                                                    <Option value="lt">小于</Option>
                                                                                    <Option value="gt">大于</Option>
                                                                                    <Option value="lte">小于等于</Option>
                                                                        ...
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <Form.Item label='比较值'>
                                                                                <Input placeholder="比较值"
                                                                                       defaultValue={p.pvalue}
                                                                                       onBlur={this.setProp(id, p.pid, 'pvalue')}/>
                                                                            </Form.Item>
                                                                        </Col>
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <a onClick={() => this.deleteProperty(p.pid)}><MinusCircleOutlined
                                                                                style={{
                                                                                    marginLeft: '10px',
                                                                                    fontSize: '16px',
                                                                                    color: '#FF4D4F',
                            ...
                            <Col span={20}>
                                <Card bordered={false} style={{marginTop: '20px'}}>
                                    <span>
                                        ...
                                        <Button onClick={this.addSeqEvent} icon={<PlusCircleOutlined/>} type='ghost'
                                                size='small' shape='round'
                                                style={{marginRight: '5px', marginLeft: '10px'}}>序列事件 </Button>
                                    </span>
                                    <Divider>
                                    </Divider>
                                    <Form.Item label="起止时间：">
                                        ...
                                        eventSeq.map((e, index) => {
                                            ...
                                            return (
                                                <Card style={{marginTop: '10px'}}>
                                                    <Row gutter={2} key={id}>
                                                        <Col span={4}>
                                                            <Form.Item label={'事件 (' + (index + 1) + ')'}>
                                                                <Select style={{width: 120}}
                                                                        onChange={this.setSeqEventName(id)}>
                                                                    <Option value="pageView">pageView</Option>
                                                                    <Option value="adShow">adShow</Option>
                                                                    <Option value="addCart">addCart</Option>
                                                                    <Option value="adClick">adClick</Option>
                                                        ...
                                                        <Col span={8}> <a
                                                            onClick={() => this.deleteSeqEvent(id)}><MinusCircleFilled
                                                            style={{
                                                                marginLeft: '10px',
                                                                fontSize: '16px',
                                                                color: 'red',
                                                    ...
                                                    <Form.Item>
                                                        <a onClick={() => this.addSeqProperty(id)}><PlusCircleFilled
                                                            style={{
                                                                fontSize: '16px',
                                                                color: 'orange',
                                                                paddingRight: '4px'
                                                                    ...
                                                                    <Row key={p.pid}>
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <Form.Item label='属性名'>
                                                                                <Input placeholder="属性名"
                                                                                       defaultValue={p.pname}
                                                                                       onBlur={this.setSeqProp(id, p.pid, 'pname')}/>
                                                                            </Form.Item>
                                                                        </Col>
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <Form.Item label='运算符'>
                                                                                <Select style={{width: 120}}
                                                                                        onChange={this.setSeqProp(id, p.pid, 'oper')}>
                                                                                    <Option value="eq">等于</Option>
                                                                                    <Option value="lt">小于</Option>
                                                                                    <Option value="gt">大于</Option>
                                                                                    <Option value="lte">小于等于</Option>
                                                                        ...
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <Form.Item label='比较值'>
                                                                                <Input placeholder="比较值"
                                                                                       defaultValue={p.pvalue}
                                                                                       onBlur={this.setSeqProp(id, p.pid, 'pvalue')}/>
                                                                            </Form.Item>
                                                                        </Col>
                                                                        <Col style={{marginLeft: '10px'}}>
                                                                            <a onClick={() => this.deleteSeqProperty(e.id, p.pid)}><MinusCircleOutlined
                                                                                style={{
                                                                                    marginLeft: '10px',
                                                                                    fontSize: '16px',
                                                                                    color: '#FF4D4F',
