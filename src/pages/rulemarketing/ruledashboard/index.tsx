                            ...
                            return (
                                <Col xl={8} lg={8} md={12} sm={24} xs={24}>
                                    <Card style={{margin: '5px'}}>
                                        ...
                                        <Divider orientation="left" plain>指标监控</Divider>
                                        <Row justify='center'>
                                            <Col span={22}>
                                                ...
                                                <Row style={{marginTop: '2px'}} align='middle' justify='start'>
                                                    <Col span={5}><Row justify='start' align='middle'><Col>
                                                        <div style={{height: '28px'}}>目标完成率：</div>
                                                    </Col></Row></Col>
                                                    <Col span={19}>
                                                        <Row justify='start'>
                                                            <Col>
                                        ...
                                        <Row justify='space-around'
                                             style={{backgroundColor: '#fffffa', height: '32px', borderRadius: '4px'}}
                                             align='middle'>
                                            <Col><PlayCircleOutlined/>
                                                <a style={{
                                                    color: r.runStatus === '1' ? 'gray' : 'green',
                                                    marginLeft: '4px',
                                                    height: '32px',
                                                    pointerEvents: r.runStatus === '1' ? 'none' : 'auto'
                                                }} onClick={this.controll('1', r.ruleId)}>启用
                                                </a>
                                            </Col>
                                            <Col><PauseCircleOutlined/><a style={{
                                                color: r.runStatus === '1' ? 'red' : 'gray',
                                                marginLeft: '4px',
                                                height: '32px',
                                                pointerEvents: r.runStatus === '1' ? 'auto' : 'none'
                                            }} onClick={this.controll('0', r.ruleId)}>停用</a></Col>
                                            <Col><StopOutlined/><a style={{
                                                color: '#ea3546',
                                                marginLeft: '4px',
                                                height: '32px'
                                            }}>删除</a></Col>
